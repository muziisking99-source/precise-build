  ...
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" aria-hidden>
      ...
      {Array.from({ length: 12 }).map((_, i) => (
        <line key={i} x1="60" y1="60" x2="60" y2="10" stroke="#FFCF47" strokeWidth="3" transform={`rotate(${i * 30} 60 60)`} opacity="0.55" />
      ))}
      <circle cx="60" cy="60" r="36" fill="#F5A800" opacity="0.18" />
      {/* cape */}
      <path d="M40 50 L60 110 L80 50 Z" fill="#C41C1C" />
      {/* body */}
      ...
      {/* belt */}
      <rect x="48" y="72" width="24" height="5" fill="#F5A800" />
      {/* SD chest emblem */}
      <text x="60" y="68" textAnchor="middle" fontFamily="Abril Fatface, serif" fontSize="9" fill="#F5A800">SD</text>
    </svg>
  );
}
...
export function GingerMan({ size = 110 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" aria-hidden>
      ...
      <circle cx="50" cy="36" r="2" fill="#E8453A" opacity="0.5" />
      <circle cx="70" cy="36" r="2" fill="#E8453A" opacity="0.5" />
      {/* bow tie */}
...
export function LuvALotGirl({ size = 110 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" aria-hidden>
      ...
      <circle cx="51" cy="44" r="1.8" fill="#E8453A" opacity="0.6" />
      <circle cx="69" cy="44" r="1.8" fill="#E8453A" opacity="0.6" />
      {/* dress */}
      <path d="M46 54 L74 54 L82 90 L38 90 Z" fill="#D4237A" />
      <rect x="56" y="54" width="8" height="6" fill="white" />
      {/* biscuit */}
      <circle cx="60" cy="74" r="10" fill="#E8D4A0" stroke="#C88400" strokeWidth="1.5" />
      <circle cx="56" cy="71" r="1" fill="#7A5C2A" />
      <circle cx="63" cy="74" r="1" fill="#7A5C2A" />
      <circle cx="59" cy="78" r="1" fill="#7A5C2A" />
      {/* hearts */}
      <path d="M30 30 q-3 -4 -6 0 q3 4 6 8 q3 -4 6 -8 q-3 -4 -6 0" fill="#E8453A" />
      <path d="M94 50 q-2 -3 -4 0 q2 3 4 6 q2 -3 4 -6 q-2 -3 -4 0" fill="#E8453A" />
    </svg>
  );
}
...
export function AllStarFootballer({ size = 110 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" aria-hidden>
      <circle cx="60" cy="60" r="46" fill="#C41C1C" opacity="0.12" />
      {/* stars */}
      <polygon points="20,30 22,36 28,36 23,40 25,46 20,42 15,46 17,40 12,36 18,36" fill="#F5A800" />
      <polygon points="100,30 102,36 108,36 103,40 105,46 100,42 95,46 97,40 92,36 98,36" fill="#F5A800" />
      {/* head */}
      ...
      {/* body kit */}
      <path d="M44 42 L66 42 L70 70 L40 70 Z" fill="#C41C1C" />
      <rect x="50" y="42" width="4" height="28" fill="white" />
      <rect x="58" y="42" width="4" height="28" fill="white" />
      {/* arms */}
      <path d="M44 46 L30 58 L34 64 L48 54 Z" fill="#C41C1C" />
      ...
      {/* motion */}
      <path d="M15 70 h10 M12 78 h14" stroke="#F5A800" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function JokerHat({ size = 110 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 120 120" aria-hidden>
      <circle cx="60" cy="60" r="46" fill="#F5A800" opacity="0.14" />
      {/* hat band */}
      <rect x="28" y="68" width="64" height="8" rx="2" fill="#1A1F2E" />
      {/* three points */}
      <path d="M30 68 L40 28 L52 68 Z" fill="#C41C1C" />
      <path d="M52 68 L60 20 L68 68 Z" fill="#1A4B8C" />
      <path d="M68 68 L80 30 L90 68 Z" fill="#2EAA4A" />
      {/* bells */}
      <circle cx="40" cy="26" r="4" fill="#F5A800" stroke="#C88400" strokeWidth="1" />
      <circle cx="60" cy="18" r="4" fill="#F5A800" stroke="#C88400" strokeWidth="1" />
      <circle cx="80" cy="28" r="4" fill="#F5A800" stroke="#C88400" strokeWidth="1" />
      {/* sparkles */}
      <g fill="#FFCF47">
      ...
      {/* JOKER text */}
      <text x="60" y="92" textAnchor="middle" fontFamily="Abril Fatface, serif" fontSize="14" fill="#1A1F2E">JOKER</text>
    </svg>
  );
}
